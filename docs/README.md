...
| config.floors[].id | <code>string</code> | 
| config.floors[].name | <code>string</code> | 
| config.rooms | <code>Array.&lt;Object&gt;</code> | 
| config.rooms[].id | <code>string</code> | 
| config.rooms[].name | <code>string</code> | 
| config.rooms[].floorID | <code>string</code> | 
| config.lights | <code>Array.&lt;Object&gt;</code> | 
| config.lights[].id | <code>string</code> | 
| config.lights[].name | <code>string</code> | 
| config.lights[].roomID | <code>string</code> | 
| config.lights[].hueID | <code>int</code> | 
| config.lights[].type | <code>string</code> | 
| config.lights[].colour | <code>string</code> | 
